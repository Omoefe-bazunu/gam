...
export default function Signup() {
  ...
  return (
    <section
      id="services"
      className="flex flex-col items-center bg-white py-20"
    >
      <div
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 font-secondary font-light">
              Join us today with a single click.
            </p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gray-100 px-6 text-lg text-primary-blue py-3 rounded-full hover:bg-primary-blue hover:text-white transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
          >
