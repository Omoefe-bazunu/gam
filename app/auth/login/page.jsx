...
export default function Login() {
  const { googleSignIn, login, loading } = useAuth();
      ...
      >
        ...
        >
          ...
          <form
            ...
            className="flex flex-col gap-4 font-secondary"
          >
            <input
              type="email"
              placeholder="Email"
          ...
          <div>
            ...
            <p className="text-center text-sm mt-1 text-gray-600 font-secondary font-light">
              <span className="text-primary-blue hover:text-orange-500 transition-colors">
